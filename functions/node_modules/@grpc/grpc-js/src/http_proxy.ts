    ...
    request.once('connect', (res, socket, head) => {
      ...
      if (res.statusCode === 200) {
        ...
        if ('secureContext' in connectionOptions) {
          ...
          resolve({
            socket,
       "N  Ä$ÄÄ ` –!ìÂfHÄñÇò@H   #0ê∫ $ , Notif ication  event reÄceived. <ÅérOØà∑–Øe¿ﬁ§q˚«¡Å˙   Ó   H  Î∞ @   "N  Ä$ÄÄ ` –!!ÌfHÄñÇò@H   #0ÿº $ 
N E 0x2 000 Even t receiv ed for d evice 0. ê†õ	’‰+W–vÍ_ ∂7t˚v
@'!,1Ç3‡¯øÇ?N6ç?É Ñ?ˇﬂ§qâOøÀãBÿ_ÌÜg. ÖHÜÉÑ¡Ä˝ˇ  •#ó ãù0√ÚÇˆ¿_†DÆh  E¡Åd  X  H  U± @   "N  Ä$ÄÄ ` –!ÑPÍHÄñÇò@H   #0 ø $ ,x  Rea dRegKey  GetValu e failed@ for v =@ Check Fi stration  and ulS ize = 26 0 with err 5code H0x0 2.~ ` Û;√Å ÄÒ7xt˚1ùõ≥'¿5LåùXı/±¯T¢qÉÅ
Äá Åâ " ÚÉN\Ñ3Ö  áˇ?  ÖÅÅ#â